...
public:
  ...
  GLdouble* multMatrix() const {
    Matrix4x4 temp = this->transpose();
    GLdouble* ret = (GLdouble*)malloc(16*sizeof(GLdouble));
...
inline Matrix4x4 operator *(double a, const Matrix4x4& b)
{
  Matrix4x4 ret;
